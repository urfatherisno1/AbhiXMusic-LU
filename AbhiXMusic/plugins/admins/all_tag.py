...
async def cancelcmd(_, message):
    ...
    if chat_id in SPAM_CHATS:
        try:
            ...
            pass
        return await message.reply_text("**ᴛᴀɢɢɪɴɢ ᴘʀᴏᴄᴇss sᴜᴄᴄᴇssғᴜʟʟʏ sᴛᴏᴘᴘᴇᴅ! Nᴏᴡ ||Jᴏɪɴ|| Tᴏ ||@imagine_iq||**")

    else:
        await message.reply_text("**Nᴏ Pʀᴏᴄᴇꜱꜱ Oɴɢᴏɪɴɢ! Nᴏᴡ ||Jᴏɪɴ|| Tᴏ ||@imagine_iq||**")
        return
