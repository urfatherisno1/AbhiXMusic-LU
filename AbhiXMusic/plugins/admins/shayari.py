...
async def cancel_spam(client, message):
    ...
    try:
        ...
        if participant.status in (
            ...
            is_admin = True
    if not is_admin:
        return await message.reply("Yᴏᴜ Aʀᴇ Nᴏᴛ Aᴅᴍɪɴ Bᴀʙʏ Oɴʟʏ Aᴅᴍɪɴꜱ Cᴀɴ Tᴀɢ Mᴇᴍʙᴇʀꜱ Nᴏᴡ ||Jᴏɪɴ|| Tᴏ ||@imagine_iq||.")
    else:
        try:
            spam_chats.remove(message.chat.id)
        except:
            pass
        return await message.reply("Sʜᴀʏᴀʀɪ Sᴛᴏᴘᴇᴅ Nᴏᴡ ||Jᴏɪɴ|| Tᴏ ||@imagine_iq||")
