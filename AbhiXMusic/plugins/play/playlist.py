...
from AbhiXMusic import Carbon, app
from AbhiXMusic.utils.decorators.language import language, languageCB
from AbhiXMusic.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
from AbhiXMusic.utils.pastebin import HottyBin
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from AbhiXMusic import YouTube
...
@app.on_callback_query(filters.regex("abhi_playlist") & ~BANNED_USERS)
@languageCB
